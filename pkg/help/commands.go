...
func GetCommandHelp(commandName string) *CommandHelp {
	commands := map[string]*CommandHelp{
		...
		"config": {
			...
			Flags: []FlagHelp{
				{Name: "get <key>", Type: "", Default: "", Description: "Get a config value"},
				{Name: "set <key> <value>", Type: "", Default: "", Description: "Set a config value (with type/enum validation)"},
				{Name: "add <key> <value>", Type: "", Default: "", Description: "Append a value to a list config key"},
				{Name: "remove <key> <value>", Type: "", Default: "", Description: "Remove a value from a list config key"},
				{Name: "list", Type: "", Default: "", Description: "List all config values with origin ([file]/[env]/[default])"},
				{Name: "unset <key>", Type: "", Default: "", Description: "Remove a config key (reverts to default)"},
